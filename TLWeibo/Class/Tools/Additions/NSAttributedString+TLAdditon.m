//
//  NSAttributedString+TLAdditon.m
//
//  Created by lichuanjun on 2017/6/8.
//  Copyright © 2017年 lichuanjun. All rights reserved.
//

#import "NSAttributedString+TLAdditon.h"

@implementation NSAttributedString (TLAdditon)

+ (instancetype)tl_imageTextWithImage:(UIImage *)image imageWH:(CGFloat)imageWH title:(NSString *)title fontSize:(CGFloat)fontSize titleColor:(UIColor *)titleColor spacing:(CGFloat)spacing {
